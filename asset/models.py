...
class AssetInfo(models.Model):
    ...
    mac = models.CharField(max_length=128,verbose_name="MAC地址",unique=True,null=True,blank=True)
    ...
    is_active = models.CharField(max_length=64,choices=STATUS_CHOICES,default='在线',verbose_name='状态')
